...
/* ===== STATIC CHART DATA (until backend provides analytics) ===== */
    ...
    <div className="flex bg-background-light min-h-screen">
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 mb-10">
          <Stat title="Total Products" value={stats.products} growth="" />
          <Stat title="Total Orders" value={stats.orders} growth="" />
          <Stat title="Users" value={stats.users} growth="" />
          <Stat title="Categories" value={stats.categories} growth="" />
        </div>
            ...
            <tbody>
              {ordersList.map((o, i) => (
                <tr key={i} className="border-t hover:bg-gray-50 transition">
                  <td className="py-3 text-blue-600 font-semibold">{o.id}</td>
                  <td>{o.customer}</td>
                  <td>{o.product}</td>
                  <td>{o.value}</td>
                  <td>
