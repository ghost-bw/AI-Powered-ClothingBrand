...
const CollectionsPage = () => {
  ...
  const categories = ["All", ...new Set(Object.values(productsData).map(p => p.category))];
      ...
      <div className="bg-linear-to-r from-gray-900 to-gray-800 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-gray-300 max-w-2xl mx-auto">
            Discover our curated selection of sustainable, handcrafted fashion pieces
          </p>
        </div>
      </div>
            ...
            <div className="bg-white rounded-lg shadow-sm p-6 sticky top-24">
                ...
                <div className="space-y-2">
                  {categories.map(category => (
                    <button
                      ...
                      className={`block w-full text-left px-3 py-2 rounded ${selectedCategory === category ? "bg-black text-white" : "hover:bg-gray-100"}`}
                    >
                      {category}
                    </button>
                  ))}
              ...
              <div className="mb-6 pb-6 border-b">
                ...
                <div className="space-y-4">
                  <div>
                    <label className="text-sm text-gray-600 mb-2 block">Min Price: ₹{priceRange[0].toLocaleString()}</label>
                    <input
                      type="range"
                      min="0"
                      max="50000"
                  ...
                  <div>
                    <label className="text-sm text-gray-600 mb-2 block">Max Price: ₹{priceRange[1].toLocaleString()}</label>
                    <input
                      type="range"
                      min="0"
                      max="50000"
                  ...
                  <div className="bg-gray-50 p-3 rounded-lg flex justify-between items-center">
                    ...
                    <span className="font-semibold text-black">₹{priceRange[0].toLocaleString()} - ₹{priceRange[1].toLocaleString()}</span>
                  </div>
                </div>
              </div>
          ...
          <div className="lg:w-3/4">
            <div className="flex justify-between items-center mb-6">
              <p className="text-gray-600">
                Showing {filteredProducts.length} of {Object.keys(productsData).length} products
              </p>
            </div>
